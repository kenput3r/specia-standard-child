...
function child_theme_enqueue_styles() {
    ...
    $specia_font_awesome = 'specia-font-awesome-css';
    ...
    wp_enqueue_style('new-font-awesome', 'https://use.fontawesome.com/releases/v5.6.3/css/all.css', array($specia_font_awesome), false);
}
